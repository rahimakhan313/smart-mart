...
try{
    ...
    $handle = $link->prepare("select id,name, high_sold from products where category='instant foods'"); 
...
?>
 ...
 var chart = new CanvasJS.Chart("chartContainer", {
     ...
     theme: "dark2",
     title:{
         text: "product's sale of instant food"
     },
 ...
 <div id="chartContainer" class="background" style='top: 40%'></div>
