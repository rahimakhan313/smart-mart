...
?>
		...
		<div class="w3l_banner_nav_right">
		    <header class="main-header" role="banner">
		        <img src="images/petf.jpg" alt="Banner Image" width=1150px height=650px/>
	        </header>
		...
		style="font family: 'Abril Fatface',cursive;"> <font color="FireBrick "  size="60"> "Pet Food" </font></h1> 
		<div class="row">
		<?php 
	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["item_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="pet_food.php"</script>';
			}
		}
	}
}
	...
	<body>
		...
		<div class="container">
			...
			<?php
                 ...
                 */
				$query = "SELECT * FROM products where category='pet food'";
				...
				?>
			<div class="col-md-4" >
				<form method="post" action="pet_food.php?action=add&id=<?php echo $row["id"]; ?>">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="pet_food.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
