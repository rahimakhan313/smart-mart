...
?>
		...
		<div class="w3l_banner_nav_right">
		    <header class="main-header" role="banner">
		        <img src="images/pul.jpg" alt="Banner Image" height=650px width=1200px/>
	        </header>
		...
		style="font family: 'Abril Fatface',cursive;"> <font color="FireBrick "  size="60"> "Pulses" </font></h1> 
		<div class="row">
		<?php 
	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["item_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="pulses.php"</script>';
			}
		}
	}
}
	...
	<body>
		...
		<div class="container">
			...
			<?php
				...
				?>
			<div class="col-md-4" >
				<form method="post" action="pulses.php?action=add&id=<?php echo $row["id"]; ?>">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="pulses.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
