...
?>
		<div class="w3l_banner_nav_right">
		    <header class="main-header" role="banner">
		        <img src="images/beverages.jpg" alt="Banner Image" width=1200px height=650px/>
	        </header>
		...
		style="font family: 'Abril Fatface',cursive;"> <font color="FireBrick "  size="60"> "beverages" </font></h1> 
		<div class="row">
		<?php 
