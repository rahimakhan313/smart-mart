...
?>
		<div class="w3l_banner_nav_right">
		    <header class="main-header" role="banner">
		        <img src="images/kit.jpg" alt="Banner Image"/>
	        </header>
		...
		style="font family: 'Abril Fatface',cursive;"> <font color="FireBrick "  size="60"> "Kitchen" </font></h1> 
		<div class="row">
		<?php 
	...
	<body>
		...
		<div class="container">
			...
			<?php
                 ...
                 */
				$query = "SELECT * FROM products where category='kitchen'";
				...
				?>
			<div class="col-md-4" >
				<form method="post" action="kitchen.php?action=add&id=<?php echo $row["id"]; ?>">
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="kitchen.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
