...
?>
		<div class="w3l_banner_nav_right">
		    <header class="main-header" role="banner">
		        <img src="images/veg.png" alt="Banner Image" width=1200px height=650px />
	        </header>
		...
		style="font family: 'Abril Fatface',cursive;"> <font color="FireBrick "  size="60"> "Vegetables" </font></h1> 
		<div class="row">
		<?php 
	...
	if($_GET["action"] == "delete")
	{
		foreach($_SESSION["shopping_cart"] as $keys => $values)
		{
			if($values["item_id"] == $_GET["id"])
			{
				...
				echo '<script>window.location="vegetables.php"</script>';
			}
		}
	}
}
			...
			<div class="table-responsive">
				<table class="table table-bordered">
					...
					<tr>
						...
						<td><a href="vegetables.php?action=delete&id=<?php echo $values["item_id"]; ?>"><span class="text-danger">Remove</span></a></td>
					</tr>
